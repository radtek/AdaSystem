        ...
        public ActionResult GetList(BusinessOrderView viewModel)
        {
            ...
            return Json(new
            {
                ...
                rows = result.Select(d => new BusinessOrderView
                {
                    ...
                    TotalMoney = d.BusinessOrderDetails.Where(a => a.Status == Consts.StateOK).Sum(o => o.Money),
                    Transactor = d.Transactor,
                    Status = d.Status ?? Consts.StateLock,
                    OrderDate = d.OrderDate,
                    TotalSellMoney = d.BusinessOrderDetails.Where(a => a.Status == Consts.StateOK).Sum(o => o.SellMoney),
                    TotalTaxMoney = d.BusinessOrderDetails.Where(a => a.Status == Consts.StateOK).Sum(o => o.TaxMoney),
