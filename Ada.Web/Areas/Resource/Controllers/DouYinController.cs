...
namespace Resource.Controllers
{
    public class DouYinController : BaseController
    {
        ...
        public DouYinController(IMediaService mediaService,
        ...
        {
            string path = Server.MapPath("~/upload/douyin.xlsx");
            int count = 0;
            using (FileStream ms = new FileStream(path, FileMode.Open))
            {
                ...
                for (int i = 1; i <= sheet.LastRowNum; i++)
                {
                    ...
                    price1.AdPositionId = "X1804031723448509";
                    price1.AdPositionName = "线上活动";
                    ...
                    price2.AdPositionId = "X1804031723448510";
                    price2.AdPositionName = "线下活动";
                    ...
                    price3.AdPositionId = "X1804031723448511";
                    price3.AdPositionName = "直发";
                    ...
                    price4.AdPositionId = "X1804031723448512";
                    price4.AdPositionName = "原创";
                    ...
                    media.AddedById = media.TransactorId;
                    media.IsSlide = true;
