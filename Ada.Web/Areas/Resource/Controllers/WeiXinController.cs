        ...
        public ActionResult Import()
        {
            ...
            using (FileStream ms = new FileStream(path, FileMode.Open))
            {
                ...
                for (int i = 1; i <= sheet.LastRowNum; i++)
                {
                    ...
                    media.MediaLink = row.GetCell(2)?.ToString().Trim();
                    ...
                    decimal.TryParse(row.GetCell(4)?.ToString(), out var pt1);
                    ...
                    decimal.TryParse(row.GetCell(5)?.ToString(), out var pt2);
                    ...
                    decimal.TryParse(row.GetCell(7)?.ToString(), out var pt4);
